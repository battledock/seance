import { PRODUITS_CONFISERIE } from "../../data/concessions.js?v=becf21cb";
import { deconnexion } from "../../auth.js?v=becf21cb";
import { confiserieActive, tauxAchat } from "../../data/concessions.js?v=becf21cb";
import { obtenirBonusSalle } from "../../data/upgrades.js?v=becf21cb";
import { Etat, fmtArgent } from "../../game-state.js?v=becf21cb";
import { bobCompact } from "../../navigation.js?v=becf21cb";
import { majBadgeNotifications } from "./community-social.js?v=becf21cb";
import {
  XP,
  deblocagesReels,
  estDebloque,
  ...
  recompenseParCle,
  xpActuel
} from "../../progression.js?v=becf21cb";
import { salles } from "../../rooms.js?v=becf21cb";
import { sbFetch } from "../../supabase-client.js?v=becf21cb";
