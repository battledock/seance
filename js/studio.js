...
import { afficheXpServeur } from "./rooms.js?v=becf21cb";
import { brancheBureau, bureauStudio } from "./ui/desk.js?v=becf21cb";
import { chargeCinema } from "./game-state.js?v=becf21cb";
import { echappe } from "./ui/emblems.js?v=becf21cb";
import { idOperation } from "./api.js?v=becf21cb";
...
import { niveauActuel } from "./progression.js?v=becf21cb";
import { toastSocial } from "./social.js?v=becf21cb";
import { appelSecurise, rpc } from "./supabase-client.js?v=becf21cb";
import { texteSur } from "./ui/emblems.js?v=becf21cb";
import { icone } from "./ui/icons.js?v=becf21cb";
import { afficheFilmSVG, propositionsAffiche } from "./ui/poster.js?v=becf21cb";
